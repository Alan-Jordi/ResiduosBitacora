...
@Component({
  selector: 'app-edita-alta-recolectores',
  templateUrl: './edita-alta-recolectores.component.html',
  styleUrls: ['./edita-alta-recolectores.component.css'],
  providers: [ServicioAlertasRecolectoresPermiso, ServicioInfoAlta, Modales]
})
export class EditaAltaRecolectoresComponent{
  ...
  adelPagina(): void{
    ...
    let desdeDate = new Date(vigInicio.value);
    ...
    let hastaDate = new Date(vigFin.value);
    ...
    // this.router.navigateByUrl('detalle-recolectores');
    console.log(this.servicioInfo.permisoGet)
  }
  date(): string{
