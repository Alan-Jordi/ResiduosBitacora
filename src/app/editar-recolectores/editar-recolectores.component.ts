...
@Component({
  selector: 'app-editar-recolectores',
  templateUrl: './editar-recolectores.component.html',
  styleUrls: ['./editar-recolectores.component.css'],
  providers: [ServicioAlertasRecolectoresDetalles, Modales]
})
export class EditarRecolectoresComponent {
